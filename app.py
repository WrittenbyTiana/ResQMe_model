...
def predict():
 ...
 # NOT BREATHING (Highest Priority)
    ...
    if "not breathing" in message or "no breathing" in message:
        first_aid = [
 ...
 # SEVERE BLEEDING
     ...
     first_aid = [
  "Apply firm pressure to the bleeding area using cloth or clothing",
  "Do not remove the cloth if soaked, add another cloth",
  "Raise injured area slightly if possible",
  "Keep victim lying down",
  "Continue pressure until help arrives",
  "Use clean clothing, scarf or towel if bandage is unavailable"
    ]
 ...
 # ACTION DECISION
    if 'severity' == "Critical":
        ...
        action = "Provide basic first aid guidance"
        priority = 3
